...
def test_sendcrypto_succes(sys_stdout):
    ...
    responses.add(responses.GET, api['utxo'].format('t1ggACQ3HenPuiwEaL9vBFcDtxQogHvXzvt'),
    ...
    responses.add(responses.GET, api['utxo'].format('t1TJ7cjWWBxozgekVWVKzCCXKhK4F59v4HB'),
