...
def test_verify_one_input():
    ...
    raw_transaction_mod = (
        '020000000169ab945e88fc3d73d052e8c3ce546309a635458fea2c6b3e69981945b0d2a62201000000'
        + reverse_byte_hex(hex(len(funding_script))[2:])
        + funding_script.hex()
        + 'fdffffff025641e52d000000001976a914759d667709c9d1fbd7aa26537b5c441747d88f2588ac80c3c901000000001976a9146928f2f330f57e6916543481ab3af69597ae289d88ac06d70700'
        + '01000000'
    )

    result = verify(
        bytes.fromhex(raw_transaction_mod), (r, s), public_key, secp256k1, double_sha256
    )
...
def test_verify_one_input_zeit():
    ...
    raw_transaction_mod = (
        '010000006bbc345b01ec2636bc0dc4a0fa774a1448b5cd26f90b1ebf6ab7474cb87b003dc15280043a00000000'
        + reverse_byte_hex(hex(len(funding_script))[2:])
        + funding_script.hex()
        + 'ffffffff016e2ae671000000001976a91415cdc3710d179a525dc6011f4588befc5a04ff4488ac00000000'
        + '01000000'
    )
...
def test_verify_two_inputs():
    ...
    raw_transaction_mod1 = (
        '0200000002999422d4e2a72c7bd5890922129498b7b0e68141aadb6ec920b6baee57e2586a00000000'
        + reverse_byte_hex(hex(len(funding_script1))[2:])
        + funding_script1.hex()
        + 'feffffff999422d4e2a72c7bd5890922129498b7b0e68141aadb6ec920b6baee57e2586a01000000'
        + '00'
        + 'feffffff0286e75900000000001976a914f640fe9c961287aeceefe8499754aa4516c9a31c88acc00e1602000000001976a9140272b913f2755541abcdeeea8cb9845d615daa2b88acd9080800'
        + '01000000'
    )
    ...
    raw_transaction_mod2 = (
        '0200000002999422d4e2a72c7bd5890922129498b7b0e68141aadb6ec920b6baee57e2586a00000000'
        + '00'
        + 'feffffff999422d4e2a72c7bd5890922129498b7b0e68141aadb6ec920b6baee57e2586a01000000'
        + reverse_byte_hex(hex(len(funding_script2))[2:])
        + funding_script2.hex()
        + 'feffffff0286e75900000000001976a914f640fe9c961287aeceefe8499754aa4516c9a31c88acc00e1602000000001976a9140272b913f2755541abcdeeea8cb9845d615daa2b88acd9080800'
        + '01000000'
    )
    ...
    result1 = verify(
        bytes.fromhex(raw_transaction_mod1), (r1, s1), public_key1, secp256k1, double_sha256
    )
    result2 = verify(
        bytes.fromhex(raw_transaction_mod2), (r2, s2), public_key2, secp256k1, double_sha256
    )
...
def test_create_p2pkh_transaction_single_input_two_outputs(sign_mock):
    ...
    raw_transaction = (
        '020000000169ab945e88fc3d73d052e8c3ce546309a635458fea2c6b3e69981945b0d2a622'
    ...
    inputs = [
        {
            'transaction_id': '69ab945e88fc3d73d052e8c3ce546309a635458fea2c6b3e69981945b0d2a622',
            'output_index': 1,
    ...
    outputs = [
        {'address': '1Bitcoinmw2Ui5A547MRjgnGi1Pk25jBzi', 'satoshis': 769999190},
...
def test_create_p2pkh_transaction_two_inputs_two_outputs(sign_mock):
    ...
    raw_transaction = (
        '0200000002999422d4e2a72c7bd5890922129498b7b0e68141aadb6ec920b6baee57e2586a'
    ...
    outputs = [
        {'address': '1PT566Ng2hKvDooBNhp7UHU3PrF3UdCgjf', 'satoshis': 5891974},
...
def test_create_zeit_p2pkh_transaction_single_input_single_output(sign_mock):
    ...
    raw_transaction = (
        '010000006bbc345b01ec2636bc0dc4a0fa774a1448b5cd26f90b1ebf6ab7474cb87b003dc1'
    ...
    inputs = [
        {
            'transaction_id': '3a048052c13d007bb84c47b76abf1e0bf926cdb548144a77faa0c40dbc3626ec',
            'output_index': 0,
    ...
    transaction = POSTransaction(
        coin=coins['ZEIT'], inputs=inputs, outputs=outputs, transaction_time=b'\x6b\xbc\x34\x5b'
    )
    transaction.create()
...
def test_p2sh_transaction_one_input_one_p2pkh_output():
    ...
    raw_transaction = (
        '01000000011f79f1a2a5cc07835f74605a3293ed4b0565a2fbd53655c36c544f856a0f6e0d'
    ...
    inputs = [
        {
            'transaction_id': '1f79f1a2a5cc07835f74605a3293ed4b0565a2fbd53655c36c544f856a0f6e0d',
            'output_index': 0,
    ...
    transaction = Transaction(coin=coins['TBTC'], inputs=inputs, outputs=outputs)
    transaction.create()
...
def test_p2sh_transaction_two_inputs_one_p2sh_output():
    ...
    raw_transaction = (
        '010000000219161f0bccd38deb20594857c3c57c3cc06237e3c1d24cbe94cd0c7e2c5963fa'
    ...
    inputs = [
        {
            'transaction_id': '19161f0bccd38deb20594857c3c57c3cc06237e3c1d24cbe94cd0c7e2c5963fa',
            'output_index': 0,
...
def test_p2sh_transaction_two_p2sh_and_two_pk2sh_inputs__one_p2sh_output():
    ...
    raw_transaction = (
        '01000000040fae1a76282cc135fad92581bdfd5eafec548c13ea15d21d2b894defe0757ba9'
